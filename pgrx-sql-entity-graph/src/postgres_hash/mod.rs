...
impl ToEntityGraphTokens for PostgresHash {
    fn to_entity_graph_tokens(&self) -> TokenStream2 {
        ...
        quote! {
            #[no_mangle]
            #[doc(hidden)]
            #[allow(nonstandard_style, unknown_lints, clippy::no_mangle_with_rust_abi, nonstandard_style)]
            pub extern "Rust" fn  #sql_graph_entity_fn_name() -> ::pgrx::pgrx_sql_entity_graph::SqlGraphEntity {
                use core::any::TypeId;
                extern crate alloc;
                use alloc::vec::Vec;
                use alloc::vec;
                let submission = ::pgrx::pgrx_sql_entity_graph::PostgresHashEntity {
                    name: stringify!(#name),
                    file: file!(),
                    line: line!(),
                ...
                ::pgrx::pgrx_sql_entity_graph::SqlGraphEntity::Hash(submission)
            }
        }
    }
}
